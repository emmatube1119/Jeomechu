...
export const MENUS = [
  ...
  { name: '초밥', category: ['japanese', 'light'], ingredient: 'seafood', method: 'raw', emoji: '🍣', mood: 'fresh', moodColor: '#3498db', isSpecial: true },
  { name: '라멘', category: ['japanese'], ingredient: 'noodle', method: 'stew', emoji: '🍜', mood: 'warm', moodColor: '#f1c40f' },
  { name: '스테이크', category: ['western'], ingredient: 'meat', method: 'grill', emoji: '🥩', mood: 'fancy', moodColor: '#8e44ad', isSpecial: true },
  { name: '파스타', category: ['western'], ingredient: 'noodle', method: 'mix', emoji: '🍝', mood: 'fancy', moodColor: '#e74c3c', isSpecial: true },
  ...
  { name: '회', category: ['japanese', 'light'], ingredient: 'seafood', method: 'raw', emoji: '🐟', mood: 'fresh', moodColor: '#3498db', isSpecial: true },
  { name: '햄버거', category: ['western'], ingredient: 'meat', method: 'fry', emoji: '🍔', mood: 'casual', moodColor: '#f1c40f' },
  { name: '족발', category: ['korean', 'night'], ingredient: 'meat', method: 'stew', emoji: '🍖', mood: 'party', moodColor: '#8e44ad', isSpecial: true },
  { name: '랍스터', category: ['western', 'fancy'], ingredient: 'seafood', method: 'stew', emoji: '🦞', mood: 'fancy', moodColor: '#e74c3c', isSpecial: true }
];
